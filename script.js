...
const BOOKS = [
  ...
  { id:'h1', title:{ky:'Manas. Choң jomok',ru:'Манас. Великий эпос'}, author:'С.Каралаев', price:1200, category:'fiction', cover:'#962a1f', image:'images/manas.jpg', badge:{ky:'Хит',ru:'Хит'}, pages:450, format:'hard' },
...
const I18N = {
  ky:{
    ...
    about_p:'BiyPara 2021-жылы Бишкекте ачылган. Биздин максат — Кыргызстандын ар бир аймагына сапаттуу окуу китептерин жеткирүү.',
    ...
    price_from:'д ан', price_to:'чейин', filter_apply:'Колдонуу', filter_reset:'Тазалоо',
  ...
  ru:{
    ...
    about_p:'BiyPara открылся в Бишкеке в 2021 году. Наша цель — доставить качественные книги в каждый уголок Кыргызстана.',
